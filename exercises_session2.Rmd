...
~/pipelines/workshop/driving.Rdata
...
* Download the expression data (expressionpd.txt) from www.github.com/shwetaramdas/prepR
...
* Make a hypothesis about the difference in age of drivers that are distracted by **toddlers** compared to age of drivers distracted by the **radio**. Test that hypothesis using t.test() and wilcox.test()
